...
/// File-based logger that writes to ~/Library/Logs/ClaudeStat/ClaudeStat.log
...
public final class FileLogger: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.x.ClaudeStat.FileLogger")
    ...
    private init() {
        ...
        let logsDir = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask).first!
            ...
            .appendingPathComponent("ClaudeStat", isDirectory: true)
        ...
        self.fileURL = logsDir.appendingPathComponent("ClaudeStat.log")
    }
